...
HD_PWD='C:/Users/david/Desktop/project_Finish/project_Finish.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log newtop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source newtop.tcl -notrace
