...
HD_PWD='C:/Users/david/Desktop/project_Finish/project_Finish.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log newtop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source newtop.tcl
